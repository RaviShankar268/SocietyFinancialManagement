...
<%
	...
	else if(session.getAttribute("sql2")==null)
	{
		response.sendRedirect("ViewOutwardF");
	}
...
<div class="container-fluid">
	<div class="ico">
		<div class="dropdown pk">
  			...
  			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    			<a class="dropdown-item" href="ViewOutward">Amount</a>
   				<a class="dropdown-item" data-toggle="collapse" href="#example" aria-expanded="false" aria-controls="example">Date</a>
  			</div>
		</div>
		<a class="btn btn-default btn-lg pp" target="_blank" href="OutwardReport?sql=${sql2}" role="button">
			<span class="fa fa-download" aria-hidden="true"></span></a>
	</div>
	<div class="collapse" id="example">
		<div class="card">
			<div class="card-body">
				<form action="ViewOutward1" method="post">
	...
	<div class="avail">
		<c:set var="sql1" value="select * from outward"/>
		...
		<table class="table table-bordered table-hover">
			...
			<tr>
				<th scope="col" class="op">Type</th>
				<th scope="col" class="op">To</th>
		...
		<c:forEach var="row" items="${result.rows}">
			<tbody>
			<tr>
				<td class="op"><c:out value="${row.type}"></c:out></td>
				<td class="op"><c:out value="${row.tot}"></c:out></td>
