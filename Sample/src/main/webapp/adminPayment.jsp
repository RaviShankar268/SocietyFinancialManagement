...
<%
	...
	{
		response.sendRedirect("AdminPaymentF");
	}
...
<div class="container-fluid">
	<div class="row">
		<div class="col-sm-4 py1"><a href="outward.jsp" id="outward"> outward payment </a></div>
		<div class="col-sm-4 py1 p2"><a href="AllPaymentF" id="available"> ALL TRANSACTIONS </a></div>
		<div class="col-sm-4 py1 p2"><a href="aggregate.jsp" id="aggregate"> AGGREGATE </a></div>
	</div>
	<div class="ico">
		<div class="dropdown pk">
  			...
  			<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    			<a class="dropdown-item" href="<%=request.getContextPath()%>/AdminPayment">Delay</a>
    			<a class="dropdown-item" data-toggle="collapse" href="#example" aria-expanded="false" aria-controls="example">Date</a>
    			<a class="dropdown-item" href="<%=request.getContextPath()%>/AdminPayment1">Yearly</a>
  			</div>
		</div>
	...
	<div class="collapse" id="example">
		<div class="card">
			<div class="card-body">
				<form action="AdminPayment2" method="post">
